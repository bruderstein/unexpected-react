...
describe('snapshots', function () {
  ...
  it('passes a single test snapshot', function () {
    ...
    var component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_TwoClickCounters2.default, null));
  ...
  describe('when update is true and the snapshot doesn`t match', function () {
    ...
    beforeEach(function () {
      ...
      component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_TwoClickCounters2.default, null));
  ...
  describe('with functions', function () {
    ...
    it('compares with a snapshot with a normal function', function () {
      ...
      component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_ClickCounter2.default, { onMouseDown: _functions2.default.anonymous() }));
      expect(component, 'to match snapshot');
    ...
    it('compares with a snapshot with a bound function', function () {
      ...
      component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_ClickCounter2.default, { onMouseDown: _functions2.default.boundContentArgs() }));
      expect(component, 'to match snapshot');
    ...
    it('fails with a snapshot with a normal function when the expected is bound', function () {
      ...
      component = _testUtils2.default.renderIntoDocument(_react2.default.createElement(_ClickCounter2.default, { onMouseDown: _functions2.default.namedContentArgs() }));
      expect(function () {
